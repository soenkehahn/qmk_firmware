...
[LAYER_1] = LAYOUT_planck_grid(
    KC_ESC     , KC_X   , KC_V   , KC_L   , KC_C       , KC_W  , KC_K  , KC_H       , KC_G   , KC_F   , KC_Q   , XXXXXXX          ,
    ...
    RGB_TOG    , KC_LCTL, KC_LALT, KC_LGUI, MO(LAYER_4), KC_SPC, KC_SPC, MO(LAYER_4), KC_LGUI, KC_RCTL, XXXXXXX, XXXXXXX
),
