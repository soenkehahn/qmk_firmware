...
[LAYER_1] = LAYOUT_planck_grid(
    ...
    RGB_TOG    , XXXXXXX, XXXXXXX, KC_LGUI, XXXXXXX, KC_SPC, KC_SPC, MO(LAYER_4), KC_LGUI, XXXXXXX, XXXXXXX , MO(LAYER_3)
),
...
[LAYER_4] = LAYOUT_planck_grid(
    XXXXXXX, XXXXXXX, KC_BSPC, KC_UP,   KC_DEL , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, KC_ESC , XXXXXXX, XXXXXXX, KC_ENT , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
)
};
